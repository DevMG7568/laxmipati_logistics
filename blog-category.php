<?php
    ...
    $blog = mysqli_query($conn,"SELECT * FROM blog WHERE category LIKE '%".$category."%' ORDER BY id DESC ");

    //fetch category

    $cat = mysqli_query($conn,"SELECT * FROM category ORDER BY id DESC");


    //fetch recent post
    $recent = mysqli_query($conn,"SELECT * FROM blog ORDER BY id DESC LIMIT 4 ");
?>
                            ...
                            <div class="widget-content">
                                <ul class="categories-list clearfix">
                                    <?php
                                        ...
                                        $counter  = mysqli_query($conn,"SELECT * FROM blog WHERE category='".$row['cat_name']."'");
