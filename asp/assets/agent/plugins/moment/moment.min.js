...
(function(a) {
    ...
    function W(a) {
        ...
        for (d = O(a._f, a._locale).match(Nb) || [],
        b = 0; b < d.length; b++)
            e = d[b],
            c = (g.match(P(e, a)) || [])[0],
            ...
            i += c.length),
            pc[e] ? (c ? a._pf.empty = !1 : a._pf.unusedTokens.push(e),
    ...
    function jb(b) {
        ...
        null === c || d === a && "" === c ? tb.invalid({
            nullInput: !0
        }) : ("string" == typeof c && (b._i = c = b._locale.preparse(c)),
        tb.isMoment(c) ? new k(c,!0) : (d ? u(d) ? Z(b) : W(b) : bb(b),
        new k(b)))
    }
    function kb(a, b) {
        var c, d;
    ...
    m(j.prototype, {
        ...
        monthsParse: function(a) {
            ...
            b = 0; 12 > b; b++)
                if (this._monthsParse[b] || (c = tb.utc([2e3, b]),
    ...
    m(tb.duration.fn = l.prototype, {
        ...
        as: function(a) {
            ...
            "month" === a || "year" === a)
                ...
                "month" === a ? c : c / 12;
            switch (b = this._days + qb(this._months / 12),
            a) {
            case "week":
