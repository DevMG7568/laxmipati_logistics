...
<form id="invoice-form" class="" method="post" autocomplete="off">
<div class="row">
<div class="col-md-6">
...
<input type="hidden" name="order_id" id="order_id" class="form-control form-control-sm" value="21819">
...
<div class="col-sm-9">
<input type="text" id="sh_add2" name="sh_add2" value="" class="form-control form-control-sm">
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
<input type="text" id="sh_state" name="sh_state" value="" class="form-control form-control-sm">
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
<input type="number" class="form-control form-control-sm" minlength="5" id="sh_ph_no" value="8758068136" name="sh_ph_no">
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
<input type="email" class="form-control form-control-sm" minlength="5" id="sh_email" value="" name="sh_email">
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
<input type="text" class="form-control form-control-sm" id="sh_referance" value="788554" name="sh_referance">
</div>
</div>
</div>
...
<div class="col-sm-4">
<input type="text" class="form-control form-control-sm" id="sh_pan_no" value="" name="sh_pan_no">
</div>
</div>
</div>
<div class="row">
...
<label class="col-sm-3 col-form-label">Address 2</label>
<div class="col-sm-9">
<input type="text" id="co_add2" name="co_add2" value="" class="form-control form-control-sm">
</div>
</div>
</div>
<div class="form-group">
...
<label class="col-sm-3 col-form-label">Country</label>
<div class="col-sm-9">
<input type="text" class="form-control form-control-sm" id="co_country" value="CANADA" name="co_country" readonly="" required="">
</div>
</div>
</div>
<div class="form-group">
...
<label class="col-sm-3 col-form-label">Email</label>
<div class="col-sm-9">
<input type="email" class="form-control form-control-sm" minlength="5" id="co_email" value="" name="co_email">
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
<input type="text" id="note" name="note" value="SDVHIJDV" class="form-control form-control-sm">
</div>
</div>
</div>
...
<div class="col-sm-9">
<input type="text" id="invoice_no_date" name="invoice_no_date" value="9136" class="form-control form-control-sm">
</div>
</div>
</div>
</div>
...
<div class="col-md-12" id="manifest_div" style="display: none;">
...
<input type="text" id="gstin" name="gstin" value="" class="form-control form-control-sm">
</div>
</div>
<div class="col-sm-3">
<div class="form-group  ">
<label>GST Invoice NO &amp; Date
</label>
<input type="text" id="gst_invoice_date" name="gst_invoice_date" value="" class="form-control form-control-sm">
</div>
</div>
<div class="col-sm-3">
<div class="form-group  ">
<label>Invoice no &amp; date(Other than GST)
</label>
<input type="text" id="invoice_date" name="invoice_date" value="" class="form-control form-control-sm">
</div>
</div>
</div>
<div class="row">
<div class="col-sm-6">
<div class="form-group  ">
<label>Whether Supply for export is on payment of IGST or not.PI Includes
</label>
<input type="text" id="igst_or_no" name="igst_or_no" value="" class="form-control form-control-sm">
</div>
</div>
<div class="col-sm-6">
<div class="form-group ">
<label>Whether Total IGST against paid.If any UT
</label>
<input type="text" id="igst_paid" name="igst_paid" value="" class="form-control form-control-sm">
</div>
</div>
</div>
</div>
...
<div class="row" id="comm" style="display: none;">
<div class="col-md-6">
...
<input type="text" id="by_full_name" name="by_full_name" value="" class="form-control form-control-sm">
</div>
<div class="form-group ">
<label>ZipCode
</label>
<input type="text" id="by_zip_code" name="by_zip_code" value="" class="form-control form-control-sm">
</div>
<div class="form-group ">
<label>Address 1
</label>
<input type="text" id="by_add1" name="by_add1" value="" class="form-control form-control-sm">
</div>
<div class="form-group">
<label>Address 2
</label>
<input type="text" id="by_add2" name="by_add2" value="" class="form-control form-control-sm">
</div>
<div class="form-group">
<label>Address 3
</label>
<input type="text" id="by_add3" name="by_add3" value="" class="form-control form-control-sm">
</div>
<div class="row">
<div class="col-sm-6">
<div class="form-group ">
...
<input type="text" id="by_city" name="by_city" value="" class="form-control form-control-sm">
</div>
</div>
<div class="col-sm-6">
<div class="form-group ">
...
<input type="text" id="by_state" name="by_state" value="" class="form-control form-control-sm">
</div>
</div>
</div>
<div class="row">
...
<input type="text" class="form-control form-control-sm" id="by_country" value="" name="by_country">
</div>
</div>
</div>
<div class="row">
...
<input type="text" class="form-control form-control-sm" id="country_origin_goods" value="" name="country_origin_goods">
</div>
</div>
</div>
</div>
...
<input type="text" id="buyers_order_no_date" name="buyers_order_no_date" value="" class="form-control form-control-sm">
</div>
</div>
</div>
<div class="row">
...
<input type="text" id="exporter_ref" name="exporter_ref" value="" class="form-control form-control-sm">
</div>
</div>
<div class="col-sm-6">
<div class="form-group  ">
...
<input type="text" id="other_referance" name="other_referance" value="" class="form-control form-control-sm">
</div>
</div>
</div>
<div class="row">
...
<input type="text" id="pre_carriage_by" name="pre_carriage_by" value="" class="form-control form-control-sm">
</div>
</div>
<div class="col-sm-6">
<div class="form-group  required">
<label> Place Of Recipt Pre Carriage By
</label>
<input type="text" id="place_of_recipt_by_pre_carrier" name="place_of_recipt_by_pre_carrier" value="" class="form-control form-control-sm">
</div>
</div>
</div>
<div class="form-group   required">
...
<input type="text" class="form-control form-control-sm" id="final_destination" value="" name="final_destination">
</div>
<div class="row">
<div class="col-sm-6">
<div class="form-group  required">
...
<input type="text" id="vessel_flight_no" name="vessel_flight_no" value="" class="form-control form-control-sm">
</div>
</div>
<div class="col-sm-6">
<div class="form-group  required">
...
<input type="text" id="container_no" name="container_no" value="" class="form-control form-control-sm">
</div>
</div>
</div>
<div class="row">
...
<input type="text" id="port_of_loading" name="port_of_loading" value="" class="form-control form-control-sm">
</div>
</div>
<div class="col-sm-6">
<div class="form-group   required">
...
<input type="text" class="form-control form-control-sm" id="port_of_discharge" value="" name="port_of_discharge">
</div>
</div>
</div>
<div class="row">
<div class="col-sm-6">
<div class="form-group  required">
<label>Terms of Payment &amp; Delivery
</label>
<input type="text" id="terms_of_delivery_payment" name="terms_of_delivery_payment" value="" class="form-control form-control-sm">
</div>
</div>
<div class="col-sm-6">
<div class="form-group   required">
...
<input type="text" class="form-control form-control-sm" id="payment_terms" value="" name="payment_terms">
</div>
</div>
</div>
<div class="form-group   required">
...
<input type="text" class="form-control form-control-sm" id="country_final_destination" value="" name="country_final_destination">
</div>
</div>
</div>
...
<div class="card-header">
<h5 class="card-title">
Box Description - Shipment Weight : <b>1.000 KG</b>
</h5>
</div>
...
<button class="btn btn-primary" type="submit" data-toggle="tooltip" data-placement="right" title="" data-original-title="Submit"><i class="pg-icon">tick</i> Submit
</button>
<a href="https://goexbox.com/agent/courierbooking" class="btn btn-warning"><i class="pg-icon">arrow_left</i> Back
</a>
</div>


<form id="pdfinvoice" name="pdfinvoice" target="_blank" method="post" action="https://goexbox.com/agent/invoice/invoice_pdf" autocomplete="off">
<input type="hidden" name="order_id" id="order_id" value="21819">
<button class="btn btn-sm btn-danger" onclick="document.forms['pdfinvoice'].submit();" data-toggle="tooltip" data-placement="top" title="" data-original-title="Custom Invoice">
<i class="pg-icon"> page</i> Invoice Pdf
</button>
</form>
...
<div class="row" id="dummy_div" style="display: none;">
<div class="col-md-12">
...
<div class="dt-action-buttons text-left">

<form style="float: left;" id="generatedummyinvoice" method="post" action="https://goexbox.com/agent/invoice/generateDummyInvoice" autocomplete="off">
<div class="row">
<div class="input-group w-auto">
<input type="hidden" name="order_id" id="order_id" value="21819">
<input type="text" id="no_of_box_per_invoice" name="no_of_box_per_invoice" class="form-control form-control-sm" placeholder="No Of Box per Invoice" required="">
<button class="btn btn-dark btn-sm" type="submit" onclick="document.getElementById('generatedummyinvoice').submit();" data-toggle="tooltip" data-placement="top" title="" data-original-title="Generate Dummy Invoice"><i class="pg-icon">plus</i>
Generate</button>
</div>
</div>
</form>
<form style="float: left;" id="deletedummyinvoice" method="post" action="https://goexbox.com/agent/invoice/deleteDummyInvoice" autocomplete="off">
<input type="hidden" name="order_id" id="order_id" value="21819">
<button type="submit" class="btn btn-sm btn-danger" onclick="document.getElementById('deletedummyinvoice').submit();" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete Dummy Invoice">
...
<div class="dropdown">
<button class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="pg-icon">grid</i></button>
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="https://goexbox.com/agent/dummy_shipper"><i class="mr-1 pg-icon">plus</i><span class="align-middle">Dummy
Shipper</span></a>
<form style="float: left;" id="viaUkInvoice" method="post" action="https://goexbox.com/agent/invoice/viaUkInvoice" autocomplete="off">
<input type="hidden" name="order_id" id="order_id" value="21819">
<button type="submit" class="dropdown-item" onclick="document.getElementById('viaUkInvoice').submit();" data-toggle="tooltip" data-placement="top" title="" data-original-title="Via UK Invoice">
<i class="mr-1 pg-icon">plus</i>UK Shipper Invoice
</button>
</form>
</div>
</div>
...
$('#invoice-form').submit(function(event) {
    $("#sh_full_name").prop('disabled', false);
    $("#co_full_name").prop('disabled', false);
    $("#sh_document_type").prop('disabled', false);
    $("#sh_document_type1").prop('disabled', false);
    ...
    $.ajax({
        url: "https://goexbox.com/agent/invoice/insert",
        type: "POST",
        data: formData,
        dataType: "JSON",
        processData: false,
        ...
        success: function(data) {
            ...
            if (data.status == true) {
                if (data.type == 2) {
                    if (confirm(
                            "Do you want to update Order Price.This is Commercial courier or Courier is Insured.Commercial or Insurance charges may change Due to Invoice value.Please Update your Order."
                        )) {
                        document.getElementById("editinvoice").submit();
                    }
                }
                noticustom(data.error, 'success');
                parent.history.back();
                return false;
            } else {
                alert(data.error);
...
<script>
		$(document).ready(function() {
			add_url = "https://goexbox.com/agent//ajax_add";
			edit_url = "https://goexbox.com/agent//ajax_edit";
			update_url = "https://goexbox.com/agent//ajax_update";
			delete_url = "https://goexbox.com/agent//ajax_delete";
			var list_url = "https://goexbox.com/agent//ajax_list";
