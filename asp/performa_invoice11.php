...
class PDF extends FPDF {
    ...
    public function __construct($sh_full_name, $co_full_name, $sh_add1, $co_add1, $sh_add2, $co_add2, $sh_add3, $co_add3, $sh_country, $co_country, $sh_ph_no, $co_ph_no, $sh_pan_no, $invoice_no_date, $id, $box_no, $weight, $totalprice) {
    ...
    function Header() {
        ...
        // For SHIPPER
        $this->Cell(95, 6, $this->sh_full_name, "LR", 0);
        $this->Cell(95, 6, $this->co_full_name, "LR", 1);
        
        $this->Cell(95, 6, $this->sh_add1, "LR", 0);
        $this->Cell(95, 6, $this->co_add1, "LR", 1);
        
        $this->Cell(95, 6, $this->sh_add2, "LR", 0);
        $this->Cell(95, 6, $this->co_add2, "LR", 1);
        
        $this->Cell(95, 6, $this->sh_add3, "LR", 0);
        $this->Cell(95, 6, $this->co_add3, "LR", 1);
        
        $this->SetFont("Arial", "", 10);
        $this->Cell(95, 6, $this->sh_country, "LR", 0);
        $this->Cell(95, 6, $this->co_country, "LR", 1);
        
        $this->Cell(95, 6, "PH NO : ". $this->sh_ph_no, "LR", 0);
        $this->Cell(95, 6, "PH NO : ". $this->co_ph_no, "LR", 1);
        
        $this->Cell(95, 6, "AADHAR NO : ". $this->sh_pan_no, "LR", 0);
        $this->Cell(95, 6, "", "LR", 1);
        
        $this->SetFont("Arial", "", 10);
        $this->Cell(95, 6, "COUNTRY OF ORIGIN : " .$this->sh_country, "LR", 0);
        $this->Cell(95, 6, "NO OF BOX : " . $this->box_no, "LRT", 1);

        $this->Cell(95, 6, "FINAL DESTINATION : " .$this->co_country, "LR", 0,);
        $this->Cell(95, 6, "TOTAL WEIGHT : " .$this->weight, "LR", 1,);
        
        $this->SetFont("Arial", "B", 10);
        $this->Cell(110, 8, "DESCRIPTION OF GOODS", "LRTB", 0,);
        $this->Cell(27, 8, "PRICE", "LRTB", 0,);
        $this->Cell(26, 8, "QTY", "LRTB", 0,);
        $this->Cell(27, 8, "TOTAL INR", "LRTB", 1,);
       
    }
     // Footer function
    function Footer() {
        $this->SetY(-33); // Move to the bottom of the page
        
        $this->Cell(126, 8, "INR SEVEN HUNDRED AND THIRTY FIVE ONLY", "LRT", 0,);
        $this->SetFont("Arial", "B", 10);
        $this->Cell(31, 8, "TOTAL(INR)", "LRT", 0,);
        $this->Cell(33, 8, $this->totalprice, "LRT", 1);
        
        $this->SetFont("Arial", "", 10);
        $this->Cell(126, 5, "WE HERE BY CONFIRM THAT THE PARCEL DOES NOT INVOLVE ANY", "LRT", 0,);
        $this->SetFont("Arial", "B", 10);
        $this->Cell(64, 5, "For , " .$this->sh_full_name, "LRT", 1,);
        
        $this->SetFont("Arial", "", 10);
        $this->Cell(126, 5, " COMMERCIAL TRANSACTION. THE VALUE IS DECLARED FOR.", "LR", 0,);
        $this->Cell(64, 5, "", "LR", 1,);
        
        $this->Cell(126, 5, " CUSTOMS PURPOSE ONLY.", "LRB", 0,);
        $this->SetFont("Arial", "B", 10);
        $this->Cell(64, 5, "PREPAID BY", "LRB", 1,);
        $this->SetFont("Arial", "", 10);

        $this->SetFont('Arial', '', 8);
        $this->Cell(190, 8, "THIS IS A COMPUTER GENERATED INVOICE", "", 1, 'C');
    }
...
$pdf = new PDF($sh_full_name, $co_full_name, $sh_add1, $co_add1, $sh_add2, $co_add2, $sh_add3, $co_add3, $sh_country, $co_country, $sh_ph_no, $co_ph_no, $sh_pan_no, $invoice_no_date, $id, $box_no, $weight, $totalprice);
$pdf->AddPage();
