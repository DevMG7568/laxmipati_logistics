<?php
    ...
    //fetch faq
    $faq = mysqli_query($conn,"SELECT * FROM faqs ORDER BY id DESC");
    ...
    <section class="faq-section">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <p><b>PLEASE READ THESE TERMS AND CONDITIONS OF USE CAREFULLY. THESE TERMS AND CONDITIONS MAY HAVE CHANGED SINCE YOUR LAST VISIT TO THIS WEBSITE. BY USING THIS WEBSITE, YOU (“YOU”) INDICATE YOUR ACCEPTANCE OF THESE TERMS AND CONDITIONS. IF YOU DO NOT ACCEPT THESE TERMS AND CONDITIONS, THEN DO NOT USE THIS WEBSITE OR USE ANY OF Laxmipati’S SERVICES. IF YOU ARE PARTY TO A SEPARATE CLICK THROUGH OR SIGNED AGREEMENT WITH Laxmipati RELATING TO SERVICES OR DELIVERABLES, THAT AGREEMENT SHALL SUPERSEDE THIS AGREEMENT WITH RESPECT TO SUCH SERVICES OR DELIVERABLES.</b></p>
    <br><br><h5 class=" text-left"><b>1. Copyright and Trademark Information</b></h5>
               
                <p class="text-left">This website (this "Website"), and the information which it contains, such as text, graphics, images, data, reports, links, information obtained from Laxmipati's licensors, services and other material and Deliverables (as defined below) contained on this Website or provided through Services (as defined below) made available on the Website (collectively, "Content") are the property of Laxmipati, its affiliates and its licensors, and are protected from unauthorized copying and dissemination by United States copyright law, trademark law, international conventions and other intellectual property laws. By way of example only, and not as a limitation, "Laxmipati" and the Laxmipati logo are registered trademarks of Laxmipati, Inc., under the applicable laws of the United States and/or other countries. Other Laxmipati product or service names or logos appearing on this Website are either trademarks or registered trademarks of Laxmipati, Inc. and/or its affiliates. The absence of a product or service name or logo from this list does not constitute a waiver of Laxmipati's trademark or other intellectual property rights concerning that name or logo.</p>
            ...
            <h5 class=" text-left"><b>2. Services, Subscriptions and Fees</b></h5>
                <p class="text-left"><b>Services Available Through this Website</b>. Laxmipati makes available certain services and features via this Website (each a “Service” and collectively, “Services”). Depending on the Service, such Service may be (1) publicly accessible without any purchase of the Service required; (2) accessible only to those who have purchased the Service; or (3) accessible to only those who have subscribed to that Service for a fee. By using this Website, You agree to only use the Service or Services that are publicly accessible or that You have purchased or to which You have subscribed. If You choose to use, purchase or subscribe to one of Laxmipati's Services as may be made available from time to time, additional terms and conditions may be imposed by Laxmipati via a separate click through or signed agreement. </p>
                <p class="text-left"><b>Rights to Use Website and Services</b>. Your right to use the Website and Services is limited in scope, revocable, personal, non-transferable and non-exclusive. Provided that You comply at all times with these Terms and Conditions and any separate agreement between You and Laxmipati, and subject to the limitations set forth herein, Laxmipati will provide You with access to the Website and, to the extent You subscribe or purchase Services, the Services. You are responsible for obtaining any equipment and Internet service necessary to access the Website and Services</p>
                <p class="text-left"><b>Deliverables; User Licenses</b>. You will receive specific ordered report or other deliverable (“Deliverable”) or You will receive a certain number of “User” licenses. If You choose to subscribe to Laxmipati’s Services on an ongoing basis, all Users will have access to Services, as well as any additional features made generally available on the Website while You are in good standing. Users may use help, FAQ’s, and other support made generally available on the Website. If You are simply purchasing a Deliverable available from the Website, then these terms apply only to that purchase and do not provide any ongoing right to access or use the Services. Numerous reports, data and other services are offered at the Website for additional fees. All terms used but not defined herein are set forth on the Website. You hereby covenant to ensure that all users that gain access to the Website and/or the Services from You are bound by these terms. Except as expressly set forth in this Agreement or other written agreement between You and Laxmipati, no license or other right in or to the Website, Services or Content are granted to You, by implication, estoppel, or otherwise, and all such licenses and rights are hereby reserved. </p>
                <p class="text-left"><b>Fees</b>. You shall pay all fees or charges to Your account with Laxmipati in accordance with the fees, charges, and billing terms in effect at the time You subscribe to the Services or that You order the applicable Content from the Services. You shall be responsible for any and all use, sales or other taxes arising from Your use of any Deliverables or Services provided by Laxmipati or its third party suppliers. Payments must be made according to these Terms and Conditions or any separate written agreement with Laxmipati. </p>
                <p class="text-left"><b>Login Credentials</b>. If Laxmipati provides You with a username and/or password ("Login Credentials"), You agree that You are responsible for protecting Your Login Credentials from unauthorized use, and You are responsible for all activity that occurs under those Login Credentials. You agree to notify us immediately if You believe that any of Your Login Credentials has been or may be used without Your permission so that appropriate action can be taken. Laxmipati is not responsible for any loss or damage caused by, or expense incurred by You as a result of, Your failure to safeguard Your Login Credentials. </p>
                <p class="text-left"><b>Term</b> Your subscription to Services or access to paid Content shall commence on the date You first used the Services or download or otherwise receive such Content, and shall continue for the period of time for which You have subscribed to the Services, unless earlier terminated or extended pursuant hereto. If You choose to subscribe to our Services on an ongoing basis, these terms and conditions will renew automatically for successive periods of time equal to the duration of Your initial subscription or for such renewal period as You may otherwise provide on the Website pages in which You subscribe to the Services, unless (1) for an annual subscription or other subscription term or renewal term longer than one month, either You or Laxmipati provide notice of termination more than thirty (30) days before the end of the then-applicable subscription term; or (2) for all other subscriptions, You or Laxmipati provide notice of termination before the end of the then-applicable subscription term. Either party may terminate a subscription Agreement for breach upon thirty (30) days prior written or e-mailed notice unless such breach is cured in that thirty (30) day period. You will have a perpetual license to use any Content You download during the Term, subject to the terms and conditions of Section 4. </p>
                <p class="text-left"><b>Publicity</b>. Unless otherwise agreed by Laxmipati, Your purchase of a Service constitutes granting the right to use Your name and Your company’s name and logo in Laxmipati’s on-line and/or printed marketing materials and/or in the Website, to disclose that You and/or Your company are a client of Laxmipati. </p>
            <h5 class=" text-left"><b>3. The Website Does Not Provide Commercial Advice</b></h5>
                <p class="text-left">This Website, Services and the Content are for informational purposes only. Laxmipati collects data from data providers all over the world; Laxmipati has not verified any such data or any Content on the Website and cannot and does not provide any assurances or warranties whatsoever regarding the accuracy or completeness of any such data or Content.</p>
            ...
            <h5 class=" text-left"><b>5. Limitation and Disclaiming of Liability</b></h5>
                <p class="text-left">ALL CONTENT PROVIDED ON THIS SITE IS PROVIDED "AS IS." SPECIFICALLY, BUT WITHOUT LIMITATION, Laxmipati DOES NOT WARRANT THAT: (i) THE INFORMATION ON THIS SITE, WHETHER CONTRIBUTED BY Laxmipati OR A THIRD PARTY, IS CORRECT, ACCURATE, RELIABLE OR COMPLETE; (ii) THE FUNCTIONS CONTAINED ON THIS SITE WILL BE UNINTERRUPTED OR ERROR-FREE; (iii) DEFECTS WILL BE CORRECTED, OR (iv) THIS SITE OR THE SERVER(S) THAT MAKES IT AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.</p>
                <p class="text-left">UNDER NO CIRCUMSTANCES SHALL Laxmipati BE LIABLE FOR ANY INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES, OR FOR DAMAGES FOR LOSS OF PROFITS, LOSS OF DATA, LOSS OF USE OR COSTS OF OBTAINING SUBSTITUTE GOODS OR SERVICES, ARISING OUT OR RELATING TO THE USE OF, OR THE INABILITY TO USE, THIS WEBSITE, THE SERVICES OR THE INFORMATION CONTAINED ON THIS SITE, WHETHER BASED UPON WARRANTY, CONTRACT, TORT OR OTHERWISE, EVEN IF Laxmipati HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>
                <p class="text-left">IN NO EVENT SHALL Laxmipati'S TOTAL LIABILITY TO YOU FOR ALL DAMAGES, LOSSES AND CAUSES OF ACTION RESULTING FROM YOUR USE OF THIS SITE INCLUDING THE USE OF ANY SERVICES, WHETHER IN CONTRACT, TORT OR OTHERWISE, EXCEED, IN THE AGGREGATE, THE GREATER OF (A) AMOUNTS PAID BY YOU TO Laxmipati FOR THE SERVICES IN THE TWELVE (12) MONTHS IMMEDIATELY PRECEDING THE APPLICABLE CLAIM; OR (B) ONE U.S. DOLLAR ($1). THIS LIMITATION IS CUMULATIVE AND NOT PER CLAIM.</p>
            <h5 class=" text-left"><b>6. Your Submissions</b></h5>
                <p class="text-left">You may choose to display, upload, submit, transmit or publish on or through this Website ("post") text, graphics, images, videos, sounds, data, reports, links, information, suggestions, improvements, works of authorship or any other materials to Laxmipati or any other user of the Website via the communications platform included on the Website, as it may be available from time to time (collectively, "Submissions").</p>
                <p class="text-left">By posting Submissions, You hereby grant to Laxmipati and its affiliates a non-exclusive, fully-paid, irrevocable, royalty-free, perpetual, worldwide license to use, modify, publicly perform, publicly display, reproduce and distribute such Submissions on and through this Website or other sites owned by Laxmipati or its affiliates or to incorporate such Submissions into any other products or services of Laxmipati or its affiliates. Laxmipati shall have a non-exclusive, fully-paid, irrevocable, royalty-free, perpetual, worldwide license to use or incorporate any suggestions, ideas, enhancement requests, feedback, recommendations or other information You provide relating to this Website, the services available through this Website and/or any Content</p>
                <p class="text-left">You further grant Laxmipati and its affiliates a non-exclusive, fully-paid, irrevocable, royalty-free, perpetual, worldwide license to use the profile information You provide to Laxmipati, and all other information regarding Your use of the Website, the Content and the Services for any lawful purpose, including without limitation, for marketing and advertising purposes.</p>
            ...
            <h5 class=" text-left"><b>7. Standards of User Conduct</b></h5>
                ...
                <p class="text-left">(9) impersonate any other person, including but not limited to, a customer, supplier, Laxmipati official, expert or bulletin board leader, guide or host;</p>
                ...
                <p class="text-left">Laxmipati reserves the right, without prior notice and in its sole discretion, to decide whether Submissions violate these terms and conditions for any of the above reasons or for any other reason, and if Laxmipati does so, to remove such Submissions which You post to the Website and/or terminate Your access to any restricted access Services of Laxmipati.</p>
            <h5 class=" text-left"><b>8. Links to Third-Party Web Sites</b></h5>
                <p class="text-left">This Website may contain links to non-Laxmipati web sites. These links are provided to You as a convenience, and Laxmipati is not responsible for the content of any linked web site. Any non-Laxmipati web site accessed from this Website is independent from Laxmipati, and Laxmipati has no control over the content of that web site. In addition, a link to any non-Laxmipati web site does not imply that Laxmipati endorses or accepts any responsibility for the content or use of such web site.</p>
            <h5 class=" text-left"><b>9. No Third-Party Approvals or Implied Endorsements</b></h5>
                <p class="text-left">Any third party which is the subject of profiles, reports or other information, provided by Laxmipati through this website or otherwise, likely has not approved or sponsored Laxmipati's provision of such information.  Further, in no event shall any reference to any third party or third party product or service be construed as an approval or endorsement by Laxmipati of that third party or of any product or service provided by a third party.</p>
            <h5 class=" text-left"><b>10. Notice and Take Down Procedures; Copyright Agent</b></h5>
                <p class="text-left">If You believe any materials accessible on or from this Website infringe Your copyright, You may request removal of those materials (or access thereto) from this Website by contacting Laxmipati’s copyright agent (identified below) and providing the following information:</p>
            ...
            <h5 class=" text-left"><b>11. Indemnity</b></h5>    
                <p class="text-left">You agree to indemnify, defend and hold harmless Laxmipati, its affiliates, officers, directors, employees, consultants, agents, representatives, licensors, and suppliers, from any and all claims, losses, liability, damages and/or costs (including reasonable attorneys’ fees and costs) arising out of or relating to (1) Your use of the Website, Services and/or Content; (2) Your violation of these Terms and Conditions, including without limitation any representations and warranties hereunder and any agreements incorporated by reference; and/or (3) Your infringement, or infringement by any other user of Your account(s), of any intellectual property or other right of any person or entity.</p>
            <h5 class=" text-left"><b>12. Export and Sanctions Compliance</b></h5> 
                <p class="text-left">The laws of the United States of America prohibit the export of certain software and data to particular persons, territories and foreign states. You agree not to export, reexport, resell, or transfer any Laxmipati data or services in any manner that will violate any laws. Without limiting the foregoing, You agree that You are not a Restricted Party; that You will not export, reexport, resell, or transfer any Laxmipati data or services to any person or entity that is a Restricted Party; that You will implement and maintain reasonable and appropriate procedures for preventing unauthorized access to Laxmipati data or services; and that You will notify Laxmipati immediately upon learning that You or a user of the Laxmipati data or services provided to You under this Agreement becomes a Restricted Party.</p>
            ...
            <h5 class=" text-left"><b>14. Enforcement of Terms and Conditions</b></h5>
                ...
                <p class="text-left">Laxmipati may, at its sole discretion and without notice, revise these terms at any time by updating this posting.</p>
            <h5 class=" text-left"><b>15. Other Terms</b></h5>
                ...
                <p class="text-left">You may not assign or transfer these Terms and Conditions without Laxmipati's prior written consent.</p>
                <p class="text-left">Laxmipati retains ownership of all intellectual property rights to its Content, technology, software, documentation and tools used in connection with the Website, Services, and/or Content.</p>
