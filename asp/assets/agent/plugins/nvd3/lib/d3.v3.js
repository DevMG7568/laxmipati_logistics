d3 = function() {
    ...
    function _(n) {
        return new RegExp("(?:^|\\s+)" + ca.requote(n) + "(?:\\s+|$)","g")
    }
    function w(n, t) {
        function e() {
            for (var e = -1; ++e < u; )
    ...
    function S(n) {
        ...
        return function(e, r) {
            ...
            r ? (t.lastIndex = 0,
            t.test(u) || e.setAttribute("class", x(u + " " + n))) : e.setAttribute("class", x(u.replace(t, " ")))
        }
    }
    function E(n, t, e) {
        function r() {
    ...
    function N(n) {
        return arguments.length || (n = ca.ascending),
        function(t, e) {
    ...
    function C(n, t, e) {
        ...
        function i() {
            var t, e = new RegExp("^__on([^.]+)" + ca.requote(n) + "$");
            for (var r in this)
                if (t = r.match(e)) {
                    var u = this[r];
    ...
    function it(n, t, e) {
        ...
        return (i = Ba.get(n)) ? t(i.r, i.g, i.b) : (null != n && "#" === n.charAt(0) && (4 === n.length ? (a = n.charAt(1),
        a += a,
        o = n.charAt(2),
        o += o,
        c = n.charAt(3),
        c += c) : 7 === n.length && (a = n.substring(1, 3),
        o = n.substring(3, 5),
        c = n.substring(5, 7)),
        a = parseInt(a, 16),
        o = parseInt(o, 16),
    ...
    function ot(n, t, e) {
        ...
        t = ct(t),
        e = ct(e);
        var r = nt((.4124564 * n + .3575761 * t + .1804375 * e) / Ua)
        ...
        e.parseRows = function(n, t) {
            function e() {
                ...
                if (34 === n.charCodeAt(t)) {
                    ...
                    return 13 === r ? (u = !0,
                    10 === n.charCodeAt(e + 2) && ++f) : 10 === r && (u = !0),
    ...
    function pt() {
        for (var n, t = Date.now(), e = Wa; e; )
            ...
            e = e.next;
        var r = dt() - t;
        r > 24 ? (isFinite(r) && (clearTimeout(Ja),
        Ja = setTimeout(pt, r)),
        $a = 0) : ($a = 1,
        Qa(pt))
    }
    function dt() {
        for (var n = null, t = Wa, e = 1 / 0; t; )
            t.flush ? (delete Ka[t.callback.id],
            t = n ? n.next = t.next : Wa = t.next) : (e = Math.min(e, t.then + t.delay),
            t = (n = t).next);
        return e
    }
    function mt(n, t) {
    ...
    function Ht(n, t, e, r, u) {
        ...
        i.length) {
            ...
            for (var f, s, h, g = i[0]; ; ) {
                ...
                u.lineStart();
                do {
                    if (f.visited = f.other.visited = !0,
                    f.entry) {
                        if (f.subject)
        ...
        return function(r) {
            ...
            var s, h, g, p, d, m = t(r), v = {
                ...
                polygonEnd: function() {
                    ...
                    v.lineEnd = o,
                    s = ca.merge(s),
                    s.length ? Ht(s, It, null, e, r) : (-Ha > h || p && -Ha > g) && (r.lineStart(),
                    e(null, null, 1, r),
                    r.lineEnd()),
                    r.polygonEnd(),
                    s = null
    ...
    function Ut(n, t) {
        if (!(e = n.length))
            return 0;
        for (var e, r, u, i = 0, a = 0, o = n[0], c = o[0], l = o[1], f = Math.cos(l), s = Math.atan2(t * Math.sin(c) * f, Math.sin(l)), h = 1 - t * Math.cos(c) * f, g = s; ++i < e; )
            o = n[i],
            f = Math.cos(l = o[1]),
            r = Math.atan2(t * Math.sin(c = o[0]) * f, Math.sin(l)),
            u = 1 - t * Math.cos(c) * f,
            Math.abs(h - 2) < Ha && Math.abs(u - 2) < Ha || (Math.abs(u) < Ha || Math.abs(h) < Ha || (Math.abs(Math.abs(r - s) - Fa) < Ha ? u + h > 2 && (a += 4 * (r - s)) : a += Math.abs(h - 2) < Ha ? 4 * (r - g) : ((3 * Fa + r - s) % (2 * Fa) - Fa) * (h + u)),
            g = s,
            s = r,
            h = u);
        return a
    ...
    function It(n, t) {
        return ((n = n.point)[0] < 0 ? n[1] - Fa / 2 - Ha : Fa / 2 - n[1]) - ((t = t.point)[0] < 0 ? t[1] - Fa / 2 - Ha : Fa / 2 - t[1])
    }
    function Vt(n) {
        ...
        return {
            ...
            point: function(i, a) {
                var o = i > 0 ? Fa : -Fa
                  , c = Math.abs(i - e);
                Math.abs(c - Fa) < Ha ? (n.point(e, r = (r + a) / 2 > 0 ? Fa / 2 : -Fa / 2),
                n.point(u, r),
                n.lineEnd(),
                n.lineStart(),
                n.point(o, r),
                n.point(i, r),
                t = 0) : u !== o && c >= Fa && (Math.abs(e - u) < Ha && (e -= u * Ha),
                Math.abs(i - o) < Ha && (i -= o * Ha),
                r = Xt(e, r, i, a),
                n.point(u, r),
                n.lineEnd(),
                n.lineStart(),
    ...
    function Xt(n, t, e, r) {
        ...
        return Math.abs(a) > Ha ? Math.atan((Math.sin(t) * (i = Math.cos(r)) * Math.sin(e) - Math.sin(r) * (u = Math.cos(t)) * Math.sin(n)) / (u * i * a)) : (t + r) / 2
    }
    function Zt(n, t, e, r) {
        var u;
        if (null == n)
    ...
    function Bt(n) {
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(s, h) {
                    var g, p = [s, h], d = t(s, h), m = a ? d ? 0 : u(s, h) : d ? u(s + (0 > s ? Fa : -Fa), h) : 0;
                    if (!e && (l = c = d) && n.lineStart(),
                    d !== c && (g = r(e, p),
                    (Ft(e, g) || Ft(p, g)) && (p[0] += Ha,
                    p[1] += Ha,
                    d = t(p[0], p[1]))),
                    d !== c)
                        f = 0,
                        ...
                        n.point(v[0][0], v[0][1]),
                        n.point(v[1][0], v[1][1]),
                        n.lineEnd()) : (n.point(v[1][0], v[1][1]),
                        n.lineEnd(),
                        n.lineStart(),
                        n.point(v[0][0], v[0][1])))
                    }
                    !d || e && Ft(e, p) || n.point(p[0], p[1]),
                    e = p,
                    c = d,
                    i = m
                },
        ...
        function r(n, t, e) {
            ...
            if (!(0 > M)) {
                ...
                E = k,
                k = _),
                N ? q ? E + k > 0 ^ b[1] < (Math.abs(b[0] - w) < Ha ? E : k) : E <= b[1] && b[1] <= k : A > Fa ^ (w <= b[0] && b[0] <= S)) {
                    var T = zt(m, (-v + x) / y);
                    return Ct(T, p),
                    [b, Lt(T)]
                }
    ...
    function $t(n, t, e, r) {
        function u(r, u) {
            return Math.abs(r[0] - n) < Ha ? u > 0 ? 0 : 3 : Math.abs(r[0] - e) < Ha ? u > 0 ? 2 : 1 : Math.abs(r[1] - t) < Ha ? u > 0 ? 1 : 0 : u > 0 ? 3 : 2
        }
        function i(n, t) {
        ...
        function o(u, i) {
            var a = i[0] - u[0]
              , o = i[1] - u[1]
              , c = [0, 1];
            return Math.abs(a) < Ha && Math.abs(o) < Ha ? n <= u[0] && u[0] <= e && t <= u[1] && u[1] <= r : Jt(n - u[0], a, c) && Jt(u[0] - e, -a, c) && Jt(t - u[1], o, c) && Jt(u[1] - r, -o, c) ? (c[1] < 1 && (i[0] = u[0] + c[1] * a,
            i[1] = u[1] + c[1] * o),
            c[0] > 0 && (u[0] += c[0] * a,
            u[1] += c[0] * o),
            !0) : !1
        ...
        return function(c) {
            ...
            var y, M, x, _, w, S, E, k, A, q, N = c, T = Yt(), C = {
                point: p,
                lineStart: d,
                lineEnd: m,
                polygonStart: function() {
                ...
                polygonEnd: function() {
                    c = N,
                    (y = ca.merge(y)).length ? (c.polygonStart(),
                    Ht(y, i, l, h, c),
                    c.polygonEnd()) : f([n, t]) && (c.polygonStart(),
                    c.lineStart(),
                    h(null, null, 1, c),
                    c.lineEnd(),
                    c.polygonEnd()),
    ...
    function Kt(n) {
        ...
        function e(t, u, i, a, o, c, l, f, s, h, g, p, d, m) {
            ...
            if (M > 4 * r && d--) {
                var x = a + h
                  ...
                  , T = q - u
                  , C = y * N - v * T;
                (C * C / M > r || Math.abs((v * N + y * T) / M - .5) > .3) && (e(t, u, i, a, o, c, A, q, E, x /= w, b /= w, _, d, m),
                m.point(A, q),
        ...
        return t.precision = function(n) {
            return arguments.length ? (u = (r = n * n) > 0 && 16,
            t) : Math.sqrt(r)
        }
        ,
        t
    ...
    function Qt(n) {
        ...
        var u, i, a, o, c, l = Kt(function(n, t) {
            return n = u(n, t),
            [n[0] * f + o, c - n[1] * f]
        }), f = 150, s = 480, h = 250, g = 0, p = 0, d = 0, m = 0, v = 0, y = bo, M = st, x = null, b = null;
        return t.stream = function(n) {
            return ne(i, y(l(M(n))))
        }
        ,
        t.clipAngle = function(n) {
            return arguments.length ? (y = null == n ? (x = n,
            bo) : Bt((x = +n) * Pa),
            t) : x
        }
        ,
        t.clipExtent = function(n) {
            ...
            M = null == n ? st : $t(n[0][0], n[0][1], n[1][0], n[1][1]),
            t) : b
        }
        ,
        t.scale = function(n) {
        ...
        t.translate = function(n) {
            return arguments.length ? (s = +n[0],
            h = +n[1],
            r()) : [s, h]
        }
        ,
        t.center = function(n) {
            return arguments.length ? (g = n[0] % 360 * Pa,
            p = n[1] % 360 * Pa,
            r()) : [g * Ra, p * Ra]
        }
        ,
        t.rotate = function(n) {
            return arguments.length ? (d = n[0] % 360 * Pa,
            m = n[1] % 360 * Pa,
            v = n.length > 2 ? n[2] % 360 * Pa : 0,
            r()) : [d * Ra, m * Ra, v * Ra]
        }
        ,
    ...
    function ne(n, t) {
        return {
            point: function(e, r) {
                r = n(e * Pa, r * Pa),
                e = r[0],
                t.point(e > Fa ? e - 2 * Fa : -Fa > e ? e + 2 * Fa : e, r[1])
            },
            sphere: function() {
                t.sphere()
            },
    ...
    function re(n) {
        return function(t, e) {
            return t += n,
            [t > Fa ? t - 2 * Fa : -Fa > t ? t + 2 * Fa : t, e]
        }
    }
    function ue(n) {
        var t = re(n);
        return t.invert = re(-n),
        t
    }
    function ie(n, t) {
        function e(n, t) {
    ...
    function ae(n, t) {
        ...
        return function(u, i, a, o) {
            null != u ? (u = oe(e, u),
            i = oe(e, i),
            (a > 0 ? i > u : u > i) && (u += 2 * a * Fa)) : (u = n + 2 * a * Fa,
            i = n);
        ...
        var u = Math.cos(t)
          ...
          , p = h ? function(n) {
            var t = Math.sin(n *= h) * g
              ...
              , u = e * l + t * s
              , a = e * i + t * o;
            return [Math.atan2(u, r) * Ra, Math.atan2(a, Math.sqrt(r * r + u * u)) * Ra]
        }
        : function() {
            return [n * Ra, t * Ra]
        }
    ...
    function pe(n) {
        ...
        return u.parallels = function(n) {
            return arguments.length ? r(t = n[0] * Fa / 180, e = n[1] * Fa / 180) : [t / Fa * 180, e / Fa * 180]
        }
        ,
        u
    }
    ...
    function Ae(n, t) {
        ...
        return i ? (e.invert = function(n, t) {
            ...
            return [Math.atan2(n, e) / i, 2 * Math.atan(Math.pow(a / r, 1 / i)) - Fa / 2]
        }
        ,
        e) : Ne
    }
    ...
    function ze(n) {
        function t(t) {
            ...
            for (var c, l = [], f = [], s = -1, h = t.length, g = ft(e), p = ft(r); ++s < h; )
                u.call(this, c = t[s], s) ? f.push([+g.call(this, c, s), +p.call(this, c, s)]) : f.length && (a(),
                f = []);
            return f.length && a(),
        ...
        t.interpolate = function(n) {
            return arguments.length ? (a = "function" == typeof n ? i = n : (i = jo.get(n) || Le).key,
            t) : a
        }
        ,
    ...
    function Oe(n, t) {
        return n.length < 3 ? Le(n) : n[0] + Ue((n.push(n[0]),
        n), Ie([n[n.length - 2]].concat(n, [n[1]]), t))
    }
    function Ye(n, t) {
    ...
    function Be(n, t) {
        var e = n.length - 1;
        if (e)
            for (var r, u, i = n[0][0], a = n[0][1], o = n[e][0] - i, c = n[e][1] - a, l = -1; ++l <= e; )
                r = n[l],
                u = l / e,
                r[0] = t * r[0] + (1 - t) * (i + u * o),
                r[1] = t * r[1] + (1 - t) * (a + u * c);
    ...
    function Ke(n) {
        for (var t = 0, e = n.length - 1, r = [], u = n[0], i = n[1], a = r[0] = Ge(u, i); ++t < e; )
    ...
    function We(n) {
        for (var t, e, r, u, i = [], a = Ke(n), o = -1, c = n.length - 1; ++o < c; )
            t = Ge(n[o], n[o + 1]),
            Math.abs(t) < 1e-6 ? a[o] = a[o + 1] = 0 : (e = a[o] / t,
            r = a[o + 1] / t,
            u = e * e + r * r,
        ...
        var e = {
          ...
          , r = {
            ...
            rightRegion: function(n) {
                return null == n.edge ? e.bottomSite : n.edge.region[Po[n.side]]
            }
        }
          , u = {
            bisect: function(n, t) {
            ...
            rightOf: function(n, t) {
                ...
                if (1 === e.a) {
                    var i = t.y - r.y
                      ...
                      , o = 0
                      , c = 0;
                    if (!u && e.b < 0 || u && e.b >= 0 ? c = o = i >= e.b * a : (c = t.x + t.y * e.b > e.c,
                    e.b < 0 && (c = !c),
                    c || (o = 1)),
                    !o) {
    ...
    function or(n, t, e, r, u, i) {
        if (!n(t, e, r, u, i)) {
            var a = .5 * (e + u)
              , o = .5 * (r + i)
              , c = t.nodes;
            c[0] && or(n, c[0], e, r, a, o),
            c[1] && or(n, c[1], a, r, u, o),
            c[2] && or(n, c[2], e, o, a, i),
            c[3] && or(n, c[3], a, o, u, i)
        }
    }
    function cr(n, t) {
        n = ca.rgb(n),
        ...
        var e = n.r
          ...
          , o = t.b - u;
        return function(n) {
            return "#" + ut(Math.round(e + i * n)) + ut(Math.round(r + a * n)) + ut(Math.round(u + o * n))
        }
    }
    function lr(n) {
        var t = [n.a, n.b]
    ...
    function pr(n, t) {
        var e, r = [], u = [], i = ca.transform(n), a = ca.transform(t), o = i.translate, c = a.translate, l = i.rotate, f = a.rotate, s = i.skew, h = a.skew, g = i.scale, p = a.scale;
    ...
    function mr(n, t) {
        ...
        r = 0; e = Oo.exec(t); ++r)
            ...
            l.push(null),
            o = Oo.lastIndex;
        for (o < t.length && l.push(t.substring(o)),
        r = 0,
        i = f.length; (e = Oo.exec(n)) && i > r; ++r)
            if (a = f[r],
            a.x == e[0]) {
                if (a.i)
                    if (null == l[a.i + 1])
    ...
    function Tr(n, t) {
        ...
        arguments.length ? e = t / (2 * Fa) * Math.asin(1 / n) : (n = 1,
        e = t / 4),
        function(r) {
    ...
    function Yr(n, t) {
        if (n === t)
            return n;
        for (var e = Or(n), r = Or(t), u = e.pop(), i = r.pop(), a = null; u === i; )
            a = u,
            u = e.pop(),
            i = r.pop();
        return a
    ...
    function Br(n, t) {
        return ca.rebind(n, t, "sort", "children", "value"),
        n.nodes = n,
        n.links = Kr,
        n
    }
    ...
    function Kr(n) {
        return ca.merge(n.map(function(n) {
        ...
        if ((e = n.children) && (l = e.length)) {
            ...
            l > 2))
                ...
                a = 3; l > a; a++) {
                    ...
                    if (1 == p)
                        for (c = r._pack_prev; c !== o._pack_prev && !wu(c, i); c = c._pack_prev,
                        m++)
                            ;
                    p ? (m > d || d == m && u.r < r.r ? _u(r, u = o) : _u(r = c, u),
                    a--) : (bu(r, i),
                    u = i,
                    t(i))
                }
    ...
    function Ou(n, t, e, r) {
        function u() {
            var u = Math.min(n.length, t.length) > 2 ? Ru : Hu
              , c = r ? Pr : Hr;
            return a = u(n, t, c, e),
            o = u(t, n, c, vr),
            i
    ...
    function Xu(n, t, e) {
        var r = -Math.floor(Math.log(Iu(n, t)[2]) / Math.LN10 + .01);
        return ca.format(e ? e.replace(uo, function(n, t, e, u, i, a, o, c, l, f) {
    ...
    function Zu(n, t, e, r) {
        ...
        ,
        u.domain = function(t) {
            return arguments.length ? (t[0] < 0 ? (e = Ju,
            r = Gu) : (e = Bu,
            r = $u),
            n.domain(t.map(e)),
            u) : n.domain().map(r)
        ...
        ,
        u.nice = function() {
            return n.domain(Pu(n.domain(), Ku(t))),
            u
        }
        ,
        u.ticks = function() {
        ...
        u.tickFormat = function(n, i) {
            if (arguments.length < 2 && (i = Jo),
            !arguments.length)
                return i;
            var a, o = Math.log(t), c = Math.max(.1, n / u.ticks().length), l = e === Ju ? (a = -1e-12,
            Math.floor) : (a = 1e-12,
            Math.ceil);
            return function(n) {
    ...
    function Wu(n, t) {
        ...
        ,
        e.domain = function(t) {
            return arguments.length ? (n.domain(t.map(r)),
            e) : n.domain().map(u)
        }
        ,
        e.ticks = function(n) {
    ...
    function fi(n) {
        function t(t) {
            ...
            for (var h, g, p, d = [], m = [], v = [], y = -1, M = t.length, x = ft(e), b = ft(u), _ = e === r ? function() {
                return g
            }
            : ft(r), w = u === i ? function() {
                return p
            ...
            : ft(i); ++y < M; )
                a.call(this, h = t[y], y) ? (m.push([g = +x.call(this, h, y), p = +b.call(this, h, y)]),
                v.push([+_.call(this, h, y), +w.call(this, h, y)])) : m.length && (c(),
                m = [],
                v = []);
            return m.length && c(),
        ...
        ,
        t.interpolate = function(n) {
            return arguments.length ? (c = "function" == typeof n ? o = n : (o = jo.get(n) || Le).key,
            l = o.reverse || o,
            f = o.closed ? "M" : "L",
            t) : c
        }
    ...
    function yi(n, t, e, r) {
        var u = n.id;
        return j(n, "function" == typeof e ? function(n, i, a) {
    ...
    function wi(n, t, e) {
        if (r = [],
        e && t.length > 1) {
            for (var r, u, i, a = Lu(n.domain()), o = -1, c = t.length, l = (t[1] - t[0]) / ++e; ++o < c; )
                for (u = e; --u > 0; )
                    (i = +t[o] - u * l) >= a[0] && r.push(i);
            for (--o,
            u = 0; ++u < e && (i = +t[o] + u * l) < a[1]; )
                r.push(i)
        }
        return r
    }
    ...
    function Ei(n, t, e) {
        ...
        function u(e) {
            return t(e = n(new gc(e - 1)), 1),
            e
        }
        function i(n, e) {
            return t(n = new gc(+n), e),
            n
        }
        function a(n, r, i) {
            var a = u(n)
    ...
    function qi(n) {
        return new RegExp("^(?:" + n.map(ca.requote).join("|") + ")","i")
    }
    function Ni(n) {
    ...
    function Ti(n, t, e) {
        n += "";
        var r = n.length;
        return e > r ? new Array(e - r + 1).join(t) + n : n
    }
    function Ci(n, t, e) {
        Sc.lastIndex = 0;
    ...
    function Di(n, t, e) {
        ...
        return r ? (n.m = qc.get(r[0].toLowerCase()),
        e += r[0].length) : -1
    }
    function ji(n, t, e) {
        Ec.lastIndex = 0;
        var r = Ec.exec(t.substring(e));
        return r ? (n.m = kc.get(r[0].toLowerCase()),
        e += r[0].length) : -1
    }
    function Li(n, t, e) {
        return Ai(n, Tc.c.toString(), t, e)
    }
    function Fi(n, t, e) {
        return Ai(n, Tc.x.toString(), t, e)
    }
    function Hi(n, t, e) {
        return Ai(n, Tc.X.toString(), t, e)
    }
    ...
    function Gi(n, t, e) {
        ...
        ,
        r.nice = function(n) {
            return r.domain(Pu(r.domain(), function() {
                return n
            }))
        }
        ,
        r.ticks = function(e, u) {
            ...
            if ("function" != typeof e) {
                ...
                Math.log(o / Lc[c - 1]) < Math.log(Lc[c] / o) && --c,
                e = t[c],
                u = e[1],
                e = e[0].range
            }
    ...
    try {
        ...
        var ha = fa.CSSStyleDeclaration.prototype
          , ga = ha.setProperty;
    ...
    ca.extent = function(n, t) {
        ...
        if (1 === arguments.length) {
            for (; ++i < a && (null == (e = u = n[i]) || e != e); )
                e = u = void 0;
            for (; ++i < a; )
                null != (r = n[i]) && (e > r && (e = r),
                r > u && (u = r))
        } else {
            for (; ++i < a && (null == (e = u = t.call(n, n[i], i)) || e != e); )
                e = void 0;
            for (; ++i < a; )
    ...
    ca.median = function(t, e) {
        ...
        t = t.filter(n),
        t.length ? ca.quantile(t.sort(ca.ascending), .5) : void 0
    }
    ,
    ...
    ca.zip = function() {
        if (!(u = arguments.length))
            return [];
        for (var n = -1, e = ca.min(arguments, t), r = new Array(e); ++n < e; )
            for (var u, i = -1, a = r[n] = new Array(u); ++i < u; )
                a[i] = arguments[i][n];
        return r
    }
    ,
    ...
    ca.nest = function() {
        function n(t, o, c) {
            ...
            for (var l, f, s, h, g = -1, p = o.length, d = a[c++], m = new u; ++g < p; )
    ...
    ca.behavior.drag = function() {
        ...
        function t() {
            ...
            function u() {
                ...
                g && (l(),
                ca.event.target === c && s(p, "click")),
                p.on(null != f ? "touchmove.drag-" + f : "mousemove.drag", null).on(null != f ? "touchend.drag-" + f : "mouseup.drag", null)
            }
            var i, a = this, o = e.of(a, arguments), c = ca.event.target, f = ca.event.touches ? ca.event.changedTouches[0].identifier : null, h = n(), g = 0, p = ca.select(fa).on(null != f ? "touchmove.drag-" + f : "mousemove.drag", t).on(null != f ? "touchend.drag-" + f : "mouseup.drag", u, !0);
            r ? (i = r.apply(a, arguments),
            i = [i.x - h[0], i.y - h[1]]) : i = [0, 0],
            null == f && l(),
            o({
                type: "dragstart"
            })
    ...
    ka.selectAll = function(n) {
        ...
        for (var u = -1, i = this.length; ++u < i; )
            for (var a = this[u], o = -1, c = a.length; ++o < c; )
                (e = a[o]) && (r.push(t = ya(n.call(e, e.__data__, o))),
                t.parentNode = e);
        return m(r)
    }
    ;
    ...
    ka.insert = function(n, t) {
        function e(e, r) {
            return this.insertBefore(la.createElementNS(this.namespaceURI, n), t.call(this, e, r))
        }
        function r(e, r) {
            return this.insertBefore(la.createElementNS(n.space, n.local), t.call(this, e, r))
        }
        return n = ca.ns.qualify(n),
    ...
    ka.data = function(n, t) {
        function e(n, e) {
            var r, i, a, o = n.length, s = e.length, h = Math.min(o, s), g = new Array(s), p = new Array(s), d = new Array(o);
            if (t) {
    ...
    ca.selection.enter.prototype = Ta,
    Ta.append = ka.append,
    Ta.insert = ka.insert,
    Ta.empty = ka.empty,
    Ta.node = ka.node,
    Ta.select = function(n) {
        for (var t, e, r, u, i, a = [], o = -1, c = this.length; ++o < c; ) {
            ...
            for (var l = -1, f = u.length; ++l < f; )
                (i = u[l]) ? (t.push(r[l] = e = n.call(u.parentNode, i.__data__, l)),
    ...
    ca.behavior.zoom = function() {
        function n() {
            this.on("mousedown.zoom", o).on("mousemove.zoom", f).on(ja + ".zoom", c).on("dblclick.zoom", g).on("touchstart.zoom", p).on("touchmove.zoom", d).on("touchend.zoom", p)
        }
        function t(n) {
        ...
        function o() {
            ...
            function e() {
                ...
                c && ca.event.target === o && s(f, "click.zoom")
            }
            var r = this
              , i = k.of(r, arguments)
              , o = ca.event.target
        ...
        function c() {
            m || (m = t(ca.mouse(this))),
            r(Math.pow(2, .002 * za()) * S),
            u(ca.mouse(this), m),
            a(k.of(this, arguments))
        }
        function f() {
            m = null
        }
        function g() {
            ...
            r(Math.pow(2, ca.event.shiftKey ? Math.ceil(i) - 1 : Math.floor(i) + 1)),
            u(n, e),
            a(k.of(this, arguments))
        }
        function p() {
            var n = ca.touches(this)
              , e = Date.now();
            if (v = S,
            m = {},
        ...
        return n.translate = function(t) {
            return arguments.length ? (w = t.map(Number),
            i(),
            n) : w
        }
        ,
        ...
        n.scaleExtent = function(t) {
            return arguments.length ? (E = null == t ? Da : t.map(Number),
            n) : E
        }
        ,
        n.x = function(t) {
    ...
    ;
    var za, Da = [0, 1 / 0], ja = "onwheel"in la ? (za = function() {
    ...
    ca.hsl = function(n, t, e) {
        return 1 === arguments.length ? n instanceof P ? H(n.h, n.s, n.l) : it("" + n, at, H) : H(+n, +t, +e)
    }
    ;
    ...
    ca.hcl = function(n, t, e) {
        return 1 === arguments.length ? n instanceof B ? Z(n.h, n.c, n.l) : n instanceof G ? W(n.l, n.a, n.b) : W((n = ot((n = ca.rgb(n)).r, n.g, n.b)).l, n.a, n.b) : Z(+n, +t, +e)
    }
    ;
    var Oa = B.prototype = new F;
    Oa.brighter = function(n) {
        return Z(this.h, this.c, Math.min(100, this.l + Ya * (arguments.length ? n : 1)))
    }
    ,
    Oa.darker = function(n) {
        return Z(this.h, this.c, Math.max(0, this.l - Ya * (arguments.length ? n : 1)))
    }
    ,
    Oa.rgb = function() {
    ...
    ca.lab = function(n, t, e) {
        return 1 === arguments.length ? n instanceof G ? J(n.l, n.a, n.b) : n instanceof B ? $(n.l, n.c, n.h) : ot((n = ca.rgb(n)).r, n.g, n.b) : J(+n, +t, +e)
    }
    ;
    var Ya = 18
      , Ua = .95047
    ...
    Xa.brighter = function(n) {
        return J(Math.min(100, this.l + Ya * (arguments.length ? n : 1)), this.a, this.b)
    }
    ,
    Xa.darker = function(n) {
        return J(Math.max(0, this.l - Ya * (arguments.length ? n : 1)), this.a, this.b)
    }
    ,
    Xa.rgb = function() {
    ...
    ca.rgb = function(n, t, e) {
        return 1 === arguments.length ? n instanceof rt ? et(n.r, n.g, n.b) : it("" + n, et, R) : et(~~n, ~~t, ~~e)
    }
    ;
    ...
    Za.brighter = function(n) {
        ...
        e && u > e && (e = u),
        r && u > r && (r = u),
        et(Math.min(255, Math.floor(t / n)), Math.min(255, Math.floor(e / n)), Math.min(255, Math.floor(r / n)))) : et(u, u, u)
    }
    ,
    ...
    ca.xhr = function(n, t, e) {
        ...
        var u = {}
          ...
          , a = {}
          , o = st
          , c = new (fa.XDomainRequest && /^(http(s)?:)?\/\//.test(n) ? XDomainRequest : XMLHttpRequest);
        ...
        ,
        ca.rebind(u, i, "on"),
        2 === arguments.length && "function" == typeof t && (e = t,
        t = null),
        null == e ? u : u.get(ht(e))
    }
    ,
    ...
    ca.timer = function(n, t, e) {
        ...
        var r = Ka[n.id];
        r && r.callback === n ? (r.then = e,
        r.delay = t) : Ka[n.id = ++Ga] = Wa = {
            callback: n,
            then: e,
            delay: t,
            next: Wa
        },
        $a || (Ja = clearTimeout(Ja),
        $a = 1,
        Qa(pt))
    }
    ,
    ...
    ;
    var Qa = fa.requestAnimationFrame || fa.webkitRequestAnimationFrame || fa.mozRequestAnimationFrame || fa.oRequestAnimationFrame || fa.msRequestAnimationFrame || function(n) {
        setTimeout(n, 17)
    }
      , no = "."
      , to = ","
    ...
    var uo = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i
      , io = ca.map({
        ...
        r: function(n, t) {
            return (n = ca.round(n, vt(n, t))).toFixed(Math.max(0, Math.min(20, vt(n * (1 + 1e-15), t))))
        }
    })
      , ao = st;
    if (eo) {
        var oo = eo.length;
        ao = function(n) {
            for (var t = n.lastIndexOf("."), e = t >= 0 ? "." + n.substring(t + 1) : (t = n.length,
            ""), r = [], u = 0, i = eo[0]; t > 0 && i > 0; )
    ...
    ca.geo.bounds = wt(st),
    ca.geo.centroid = function(n) {
        po = mo = vo = yo = Mo = 0,
        ca.geo.stream(n, xo);
        var t;
        return mo && Math.abs(t = Math.sqrt(vo * vo + yo * yo + Mo * Mo)) > Ha ? [Math.atan2(yo, vo) * Ra, Math.asin(Math.max(-1, Math.min(1, Mo / t))) * Ra] : void 0
    }
    ;
    var po, mo, vo, yo, Mo, xo = {
        sphere: function() {
            2 > po && (po = 2,
            mo = vo = yo = Mo = 0)
        },
    ...
    ca.geo.rotation = function(n) {
        function t(t) {
            return t = n(t[0] * Pa, t[1] * Pa),
            t[0] *= Ra,
            t[1] *= Ra,
            t
        }
        return n = ee(n[0] % 360 * Pa, n[1] * Pa, n.length > 2 ? n[2] * Pa : 0),
        t.invert = function(t) {
            return t = n.invert(t[0] * Pa, t[1] * Pa),
            t[0] *= Ra,
            t[1] *= Ra,
            t
        }
    ...
    ca.geo.circle = function() {
        ...
        ,
        n.angle = function(r) {
            return arguments.length ? (e = ae((t = +r) * Pa, u * Pa),
            n) : t
        }
        ,
        n.precision = function(r) {
            return arguments.length ? (e = ae(t * Pa, (u = +r) * Pa),
            n) : u
        }
        ,
        n.angle(90)
    ...
    ca.geo.distance = function(n, t) {
        var e, r = (t[0] - n[0]) * Pa, u = n[1] * Pa, i = t[1] * Pa, a = Math.sin(r), o = Math.cos(r), c = Math.sin(u), l = Math.cos(u), f = Math.sin(i), s = Math.cos(i);
    ...
    ca.geo.graticule = function() {
        ...
        function t() {
            return ca.range(Math.ceil(i / m) * m, u, m).map(h).concat(ca.range(Math.ceil(l / v) * v, c, v).map(g)).concat(ca.range(Math.ceil(r / p) * p, e, p).filter(function(n) {
                return Math.abs(n % m) > Ha
            }).map(f)).concat(ca.range(Math.ceil(o / d) * d, a, d).filter(function(n) {
    ...
    ca.geo.greatArc = function() {
        ...
        return n.distance = function() {
            return ca.geo.distance(t || r.apply(this, arguments), e || u.apply(this, arguments))
        }
        ,
        n.source = function(e) {
    ...
    ca.geo.albersUsa = function() {
        ...
        var e, r, u, i = ca.geo.conicEqualArea().rotate([98, 0]).center([0, 38]).parallels([29.5, 45.5]), a = ca.geo.conicEqualArea().rotate([160, 0]).center([0, 60]).parallels([55, 65]), o = ca.geo.conicEqualArea().rotate([160, 0]).center([0, 20]).parallels([8, 18]), c = ca.geo.conicEqualArea().rotate([60, 0]).center([0, 10]).parallels([8, 18]);
    ...
    ca.geo.path = function() {
        function n(n) {
            return n && ca.geo.stream(n, r(u.pointRadius("function" == typeof i ? +i.apply(this, arguments) : i))),
            u.result()
        }
        var t, e, r, u, i = 4.5;
        ...
        n.centroid = function(n) {
            return po = vo = yo = Mo = 0,
            ca.geo.stream(n, r(qo)),
            Mo ? [vo / Mo, yo / Mo] : void 0
        }
        ,
        n.bounds = function(n) {
            return wt(r)(n)
        ...
        n.projection = function(e) {
            return arguments.length ? (r = (t = e) ? e.stream || Ee(e) : st,
            n) : t
        }
        ,
        n.context = function(t) {
            return arguments.length ? (u = null == (e = t) ? new ye : new we(t),
            n) : e
        }
        ,
        n.pointRadius = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : +t,
            n) : i
        }
        ,
    ...
    ca.geom.hull = function(n) {
        function t(n) {
            if (n.length < 3)
                return [];
            var t, u, i, a, o, c, l, f, s, h, g, p, d = ft(e), m = ft(r), v = n.length, y = v - 1, M = [], x = [], b = 0;
            if (d === De && r === je)
                t = n;
            else
                for (i = 0,
            ...
            i = 1; y > i; ++i)
                a = M[i].index,
                g == M[i].angle ? (o = t[h][0] - t[b][0],
                c = t[h][1] - t[b][1],
                l = t[a][0] - t[b][0],
                f = t[a][1] - t[b][1],
                o * o + c * c >= l * l + f * f ? M[i].index = -1 : (M[s].index = -1,
                g = M[i].angle,
                s = i,
                h = a)) : (g = M[i].angle,
                s = i,
    ...
    ca.geom.polygon = function(n) {
        ...
        n.clip = function(t) {
            for (var e, r, u, i, a, o, c = -1, l = n.length, f = n[l - 1]; ++c < l; ) {
                ...
                r = -1; ++r < u; )
                    o = e[r],
                    tr(o, f, i) ? (tr(a, f, i) || t.push(er(a, o, f, i)),
                    t.push(o)) : tr(a, f, i) && t.push(er(a, o, f, i)),
                    a = o;
                f = i
            }
            return t
    ...
    ca.geom.voronoi = function(n) {
        function t(n) {
            var t, r, a, o = n.map(function() {
                return []
            }), c = ft(u), l = ft(i), f = n.length, s = 1e6;
            if (c === De && l === je)
                t = n;
            else
                for (t = [],
                ...
                if (!(r > 2)) {
                    ...
                    if (Math.abs(d) < Ha) {
                        ...
                        var m = (l - o) * (g - f) > (h - l) * (f - c) ? s : -s
                          , y = Math.abs(d) - p;
                        Math.abs(y) < Ha ? n.push([0 > d ? m : -m, m]) : (y > 0 && (m *= -1),
                        n.push([-s, m], [s, m]))
                    }
                }
            }),
        ...
        ,
        t.size = function(n) {
            return arguments.length ? (null == n ? e = null : (r = [+n[0], +n[1]],
    ...
    ca.geom.quadtree = function(n, t, e, r, u) {
                ...
                if (!isNaN(e) && !isNaN(r))
                    if (n.leaf) {
                        var c = n.x
                          , f = n.y;
                        if (null != c)
                            if (Math.abs(c - e) + Math.abs(f - r) < .01)
                                l(n, t, e, r, u, i, a, o);
                            else {
                                var s = n.point;
        ...
        var a, o = De, c = je;
        return (a = arguments.length) ? (o = ur,
        c = ir,
        3 === a && (u = e,
        r = t,
        e = t = 0),
    ...
    var Oo = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
    ca.interpolate = vr,
    ca.interpolators = [function(n, t) {
        var e = typeof t;
        return ("string" === e || e !== typeof n ? Ba.has(t) || /^(#|rgb\(|hsl\()/.test(t) ? cr : mr : t instanceof F ? cr : "object" === e ? Array.isArray(t) ? Mr : dr : gr)(n, t)
    }
    ],
    ...
    ca.ease = function(n) {
        ...
        return e = Uo.get(e) || Yo,
        r = Io.get(r) || st,
        xr(r(e.apply(null, Array.prototype.slice.call(arguments, 1))))
    }
    ,
    ...
    ca.layout.force = function() {
        ...
        var e, r, u, i, a, o = {}, c = ca.dispatch("start", "tick", "end"), l = [1, 1], f = .9, s = Vo, h = Xo, g = -30, p = .1, d = .8, m = [], v = [];
        return o.tick = function() {
            ...
            y))
                for (; ++e < b; )
                    ...
                    o.y += (x - o.y) * y;
            if (g)
                for (Zr(t = ca.geom.quadtree(m), r, a),
                e = -1; ++e < b; )
                    (o = m[e]).fixed || t.visit(n(o));
            for (e = -1; ++e < b; )
                o = m[e],
                o.fixed ? (o.x = o.px,
                o.y = o.py) : (o.x -= (o.px - (o.px = o.x)) * f,
                o.y -= (o.py - (o.py = o.y)) * f);
            c.tick({
                type: "tick",
                alpha: r
        ...
        ,
        o.drag = function() {
            return e || (e = ca.behavior.drag().origin(st).on("dragstart.force", Ur).on("drag.force", t).on("dragend.force", Ir)),
            arguments.length ? void this.on("mouseover.force", Vr).on("mouseout.force", Xr).call(e) : e
        }
        ,
        ca.rebind(o, c, "on")
    }
    ...
    ca.layout.stack = function() {
        function n(o, c) {
            ...
            for (g = 0; v > g; ++g)
                for (u.call(n, l[0][g], p = d[g], f[0][g][1]),
                h = 1; m > h; ++h)
        ...
        ,
        n.order = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : Bo.get(t) || tu,
            n) : e
        }
        ,
        n.offset = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : $o.get(t) || eu,
            n) : r
        }
        ,
        n.x = function(t) {
    ...
    var Bo = ca.map({
        "inside-out": function(n) {
            var t, e, r = n.length, u = n.map(ru), i = n.map(uu), a = ca.range(r).sort(function(n, t) {
                return u[n] - u[t]
            }), o = 0, c = 0, l = [], f = [];
            for (t = 0; r > t; ++t)
                e = a[t],
    ...
    ca.layout.histogram = function() {
        function n(n, i) {
            ...
            if (g > 0)
                for (i = -1; ++i < h; )
                    o = l[i],
                    o >= f[0] && o <= f[1] && (a = c[ca.bisect(s, o, 1, g) - 1],
                    a.y += p,
                    a.push(n[i]));
            return c
        }
        ...
        ,
        n.range = function(t) {
            return arguments.length ? (r = ft(t),
            n) : r
        }
        ,
        n.bins = function(t) {
    ...
    ca.layout.tree = function() {
        function n(n, u) {
            ...
            function o(n, t, r) {
                if (t) {
                    for (var u, i = n, a = n, o = t, c = n.parent.children[0], l = i._tree.mod, f = a._tree.mod, s = o._tree.mod, h = c._tree.mod; o = su(o),
                    i = fu(i),
                    o && i; )
                        c = fu(c),
                        a = su(a),
                        ...
                        h += c._tree.mod,
                        f += a._tree.mod;
                    o && !su(a) && (a._tree.thread = o,
                    a._tree.mod += s - f),
                    i && !fu(c) && (c._tree.thread = i,
                    c._tree.mod += l - h,
                    r = n)
                }
                return r
        ...
        var t = ca.layout.hierarchy().sort(null).value(null)
          , e = lu
          , r = [1, 1];
    ...
    ca.layout.pack = function() {
        function n(n, u) {
            ...
            return Au(a, o / 2, c / 2, 1 / l),
            i
        }
        var t = ca.layout.hierarchy().sort(xu)
          , e = 0
          , r = [1, 1];
    ...
    ca.layout.treemap = function() {
        ...
        var a, o = ca.layout.hierarchy(), c = Math.round, l = [1, 1], f = null, s = Du, h = !1, g = "squarify", p = .5 * (1 + Math.sqrt(5));
        ...
        i.padding = function(n) {
            function t(t) {
                ...
                return null == e ? Du(t) : ju(t, "number" == typeof e ? [e, e, e, e] : e)
            }
            function e(t) {
                return ju(t, n)
            }
            if (!arguments.length)
                return f;
            var r;
            return s = null == (f = n) ? Du : "function" == (r = typeof n) ? t : "number" === r ? (n = [n, n, n, n],
            e) : e,
            i
        }
        ,
    ...
    ca.svg.arc = function() {
        function n() {
            ...
            o - a)
              ...
              , h = Math.cos(o)
              , g = Math.sin(o);
            return c >= tc ? n ? "M0," + i + "A" + i + "," + i + " 0 1,1 0," + -i + "A" + i + "," + i + " 0 1,1 0," + i + "M0," + n + "A" + n + "," + n + " 0 1,0 0," + -n + "A" + n + "," + n + " 0 1,0 0," + n + "Z" : "M0," + i + "A" + i + "," + i + " 0 1,1 0," + -i + "A" + i + "," + i + " 0 1,1 0," + i + "Z" : n ? "M" + i * f + "," + i * s + "A" + i + "," + i + " 0 " + l + ",1 " + i * h + "," + i * g + "L" + n * h + "," + n * g + "A" + n + "," + n + " 0 " + l + ",0 " + n * f + "," + n * s + "Z" : "M" + i * f + "," + i * s + "A" + i + "," + i + " 0 " + l + ",1 " + i * h + "," + i * g + "L0,0Z"
        }
        var t = ii
          , e = ai
          , r = oi
        ...
        return n.innerRadius = function(e) {
            return arguments.length ? (t = ft(e),
            n) : t
        }
        ,
        n.outerRadius = function(t) {
            return arguments.length ? (e = ft(t),
            n) : e
        }
        ,
        n.startAngle = function(t) {
        ...
        ,
        n.endAngle = function(t) {
            return arguments.length ? (u = ft(t),
            n) : u
        }
        ,
        n.centroid = function() {
    ...
    ca.svg.chord = function() {
        ...
        return n.radius = function(t) {
            return arguments.length ? (o = ft(t),
            n) : o
        }
        ,
        n.source = function(t) {
            return arguments.length ? (i = ft(t),
            n) : i
        }
        ,
        n.target = function(t) {
            return arguments.length ? (a = ft(t),
            n) : a
        }
        ,
        n.startAngle = function(t) {
            return arguments.length ? (c = ft(t),
            n) : c
        }
        ,
        n.endAngle = function(t) {
            return arguments.length ? (l = ft(t),
            n) : l
        }
        ,
        n
    ...
    var rc, uc = Math.sqrt(3), ic = Math.tan(30 * Pa), ac = [], oc = 0, cc = {
        ease: Er,
        delay: 0,
        duration: 250
    };
    ...
    ac.empty = ka.empty,
    ac.node = ka.node,
    ca.transition = function(n) {
        return arguments.length ? rc ? n.transition() : n : Ca.transition()
    }
    ,
    ca.transition.prototype = ac,
    ac.select = function(n) {
        var t, e, r, u = this.id, i = [];
        "function" != typeof n && (n = v(n));
        for (var a = -1, o = this.length; ++a < o; ) {
            i.push(t = []);
            for (var c = this[a], l = -1, f = c.length; ++l < f; )
                (r = c[l]) && (e = n.call(r, r.__data__, l)) ? ("__data__"in r && (e.__data__ = r.__data__),
    ...
    ac.styleTween = function(n, t, e) {
        ...
        this.tween("style." + n, function(r, u) {
            var i = t.call(this, r, u, fa.getComputedStyle(this, null).getPropertyValue(n));
            return i && function(t) {
    ...
    ac.ease = function(n) {
        var t = this.id;
        return arguments.length < 1 ? this.node().__transition__[t].ease : ("function" != typeof n && (n = ca.ease.apply(ca, arguments)),
        j(this, function(e) {
    ...
    ac.delay = function(n) {
        var t = this.id;
        return j(this, "function" == typeof n ? function(e, r, u) {
            e.__transition__[t].delay = 0 | n.call(e, e.__data__, r, u)
        }
        : (n |= 0,
        function(e) {
    ...
    ac.duration = function(n) {
        var t = this.id;
        return j(this, "function" == typeof n ? function(e, r, u) {
            e.__transition__[t].duration = Math.max(1, 0 | n.call(e, e.__data__, r, u))
        }
        : (n = Math.max(1, 0 | n),
        function(e) {
    ...
    ac.transition = function() {
        for (var n, t, e, r, u = this.id, i = ++oc, a = [], o = 0, c = this.length; c > o; o++) {
            a.push(n = []);
    ...
    ca.svg.axis = function() {
        ...
        var t, e = ca.scale.linear(), r = lc, u = 6, i = 6, a = 6, o = 3, c = [10], l = null, f = 0;
        ...
        ,
        n.orient = function(t) {
            return arguments.length ? (r = t in fc ? t + "" : lc,
            n) : r
        }
        ,
        n.ticks = function() {
    ...
    ca.svg.brush = function() {
        function n(i) {
            i.each(function() {
                var i, a = ca.select(this), l = a.selectAll(".background").data([0]), s = a.selectAll(".extent").data([0]), h = a.selectAll(".resize").data(f, String);
                ...
                h.enter().append("g").attr("class", function(n) {
                    return "resize " + n
        ...
        function u() {
            ...
            function h() {
                32 == ca.event.keyCode && 2 == E && (k[0] += s[1][0],
                k[1] += s[1][1],
                E = 0,
                l())
            }
            function g() {
                ...
                v && (n[0] += v[0],
                n[1] += v[1]),
                E || (ca.event.altKey ? (m || (m = [(s[0][0] + s[1][0]) / 2, (s[0][1] + s[1][1]) / 2]),
                k[0] = s[+(n[0] < m[0])][0],
                k[1] = s[+(n[1] < m[1])][1]) : m = null),
                w && p(n, o, 0) && (e(b),
                i = !0),
                S && p(n, c, 1) && (r(b),
                i = !0),
            ...
            function p(n, t, e) {
                var r, u, a = Fu(t), o = a[0], c = a[1], l = k[e], f = s[1][e] - s[0][e];
                return E && (o -= l,
                c -= f + l),
                r = Math.max(o, Math.min(c, n[e])),
                E ? u = (r += l) + f : (m && (l = Math.max(o, Math.min(c, 2 * m[e] - r))),
                r > l ? (u = r,
                r = l) : u = l),
            ...
            var m, v, y = this, M = ca.select(ca.event.target), x = a.of(y, arguments), b = ca.select(y), _ = M.datum(), w = !/^(n|s)$/.test(_) && o, S = !/^(e|w)$/.test(_) && c, E = M.classed("extent"), k = u(), A = ca.select(fa).on("mousemove.brush", g).on("mouseup.brush", d).on("touchmove.brush", g).on("touchend.brush", d).on("keydown.brush", f).on("keyup.brush", h);
            if (E)
                k[0] = s[0][0] - k[0],
                k[1] = s[0][1] - k[1];
            else if (_) {
        ...
        var i, a = h(n, "brushstart", "brush", "brushend"), o = null, c = null, f = hc[0], s = [[0, 0], [0, 0]];
    ...
    pc.forEach(function(n, t) {
        ...
        var e = ca.time[n] = Ei(function(n) {
            return (n = ca.time.day(n)).setDate(n.getDate() - (n.getDay() + t) % 7),
            n
        }, function(n, t) {
    ...
    ca.time.format = function(n) {
        function t(t) {
            for (var r, u, i, a = [], o = -1, c = 0; ++o < e; )
                37 === n.charCodeAt(o) && (a.push(n.substring(c, o)),
                null != (u = Nc[r = n.charAt(++o)]) && (r = n.charAt(++o)),
                (i = Tc[r]) && (r = i(t, null == u ? "e" === r ? " " : "0" : u)),
                a.push(r),
                c = o + 1);
    ...
    var wc = qi(Mc)
      ...
      , Tc = {
        ...
        Y: function(n, t) {
            return Ti(n.getFullYear() % 1e4, t, 4)
        },
        Z: $i,
        "%": function() {
            return "%"
    ...
    ca.time.format.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? Ji : jc,
    Ji.parse = function(n) {
        var t = new Date(n);
    ...
    ca.time.second = Ei(function(n) {
        return new gc(1e3 * Math.floor(n / 1e3))
    }, function(n, t) {
    ...
    ca.time.minute = Ei(function(n) {
        return new gc(6e4 * Math.floor(n / 6e4))
    }, function(n, t) {
    ...
    ca.time.hour = Ei(function(n) {
        var t = n.getTimezoneOffset() / 60;
        return new gc(36e5 * (Math.floor(n / 36e5 - t) + t))
    }, function(n, t) {
    ...
    var Lc = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6]
      ...
      , Hc = [[ca.time.format("%Y"), jt], [ca.time.format("%B"), function(n) {
        return n.getMonth()
    }
    ], [ca.time.format("%b %d"), function(n) {
        return 1 != n.getDate()
    }
    ], [ca.time.format("%a %d"), function(n) {
        return n.getDay() && 1 != n.getDate()
    }
    ], [ca.time.format("%I %p"), function(n) {
        return n.getHours()
    }
    ], [ca.time.format("%I:%M"), function(n) {
        return n.getMinutes()
    }
    ], [ca.time.format(":%S"), function(n) {
        return n.getSeconds()
    }
    ], [ca.time.format(".%L"), function(n) {
    ...
    var Oc = Fc.map(function(n) {
      ...
      , Yc = [[ca.time.format.utc("%Y"), jt], [ca.time.format.utc("%B"), function(n) {
        return n.getUTCMonth()
    }
    ], [ca.time.format.utc("%b %d"), function(n) {
        return 1 != n.getUTCDate()
    }
    ], [ca.time.format.utc("%a %d"), function(n) {
        return n.getUTCDay() && 1 != n.getUTCDate()
    }
    ], [ca.time.format.utc("%I %p"), function(n) {
        return n.getUTCHours()
    }
    ], [ca.time.format.utc("%I:%M"), function(n) {
        return n.getUTCMinutes()
    }
    ], [ca.time.format.utc(":%S"), function(n) {
        return n.getUTCSeconds()
    }
    ], [ca.time.format.utc(".%L"), function(n) {
