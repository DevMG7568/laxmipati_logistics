...
?>
        <tr>
            ...
            <td><?php echo date('d/m/Y', strtotime($invoice_no_date)); ?></td>
            <td>LPIC5000<?php echo $row['id']; ?></td>
            <td><?php echo $sh_full_name; ?><br><?php echo $row['co_full_name']; ?></td>
            <td><?php echo $co_country; ?></td>
