...
<span class="badge me-1">LP<?php echo $row['id']; ?>
</span>
</div>
</div>
<div class="card-body">
...
<label class="col-sm-3 col-form-label">Country</label>
<div class="col-sm-9">
<input type="text" class="form-control form-control-sm" id="co_country" value="<?php echo $row['co_country']; ?>" name="co_country" readonly="" >
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
<select name="currency" id="currency" class="form-control form-control-sm" data-placeholder="Select Company" value="">
