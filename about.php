  ...
  <!---  <div id="search-popup" class="search-popup">
    ...
    <section class="who-we-are-section">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="sec-title mb-30">
                            ...
                            <h2>Provide a <br> Reliable Services <br> Since 2001</h2>
                        </div>
        ...
        <div class="overview">
            <div class="auto-container">
                <div class="wrapper-box">
                    <h2>Laxmipati has been operating in the USA now, for over 22 years and are part <br>  of a reliable, global integrated network.</h2>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="text">
                                ...
                                <p>Laxmipati has been the premiere agency to assist corporations with their global sales, resource, logistic, and import & export needs. Alongside our highly qualified workforce, we believe our track record and amassed relationships not only from our current clientele base, a growing network of over 3000 members, but also our experience as owned by the China, India and USA could be beneficial to any business with interest to expand.</p>
                            </div>
