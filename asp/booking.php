...
$sql_dj = "INSERT INTO get_start (country, document_type_id, nob, weight, order_currier_date, sh_referance, note)
           VALUES ('$country', '$documentType', '$nob', '$weight', '$orderDate', '$shReference', '$note')";
...
<form action="submit.php" id="invoice-form" method="post" enctype="multipart/form-data" autocomplete="off">
<div class="row">
<div class="col-md-6">
...
<div class="col-sm-7">
<input type="text" id="sh_full_name" name="sh_full_name" value="" class="autocomplete form-control form-control-sm" autocomplete="off">
</div>
...
<div class="col-sm-9">
<input type="text" id="sh_zip_code" name="sh_zip_code" value="" class="form-control form-control-sm" >
</div>
</div>
</div>     
<div class="form-group  required ">
...
<div class="col-sm-9">
<input type="text" id="sh_add1" name="sh_add1" value="" class="form-control form-control-sm" >
</div>
</div>
</div>
...
<div class="col-sm-9">
<input type="text" id="sh_city" name="sh_city" value="" class="autocomplete form-control form-control-sm" autocomplete="off" >
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
<input type="text" id="sh_country" name="sh_country" value="" class="form-control form-control-sm" >
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
<input type="number" class="form-control form-control-sm" minlength="5" id="sh_ph_no"  name="sh_ph_no">
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-7">
<input type="text" id="co_full_name" name="co_full_name" value="" class="autocomplete form-control form-control-sm" autocomplete="off" >
</div>
<div class="col-sm-2 center">
<a class="btn btn-complete form-control-sm" style="width: 100%;" href="#" onclick="clearShipper()">Clear</a>
</div>
...
<label class="col-sm-3 col-form-label">ZipCode</label>
<div class="col-sm-9">
<input type="text" id="co_zip_code" name="co_zip_code" value="" class="form-control form-control-sm" >
</div>
</div>
</div>
<div class="form-group  required ">
...
<label class="col-sm-3 col-form-label">Address 1</label>
<div class="col-sm-9">
<input type="text" id="co_add1" name="co_add1" value="" class="form-control form-control-sm" >
</div>
</div>
</div>
<div class="form-group">
...
<label class="col-sm-3 col-form-label">City</label>
<div class="col-sm-9">
<input type="text" id="co_city" name="co_city" value="" class="form-control form-control-sm" >
</div>
</div>
</div>
<div class="form-group">
...
<label class="col-sm-3 col-form-label">State</label>
<div class="col-sm-9">
<input type="text" id="co_state" name="co_state" value="" class="form-control form-control-sm" >
</div>
</div>
</div>
...
<label class="col-sm-3 col-form-label">Country</label>
<div class="col-sm-9">
<input type="text" class="form-control form-control-sm" id="co_country" value="" name="co_country" readonly="" required="">
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
<input type="text" id="note" name="note" value="" class="form-control form-control-sm">
</div>
</div>
...
<div class="col-sm-9">
<input type="date" id="invoice_no_date" name="invoice_no_date" value="" class="form-control form-control-sm">
</div>
</div>
</div>
...
<div class="col-sm-9">
<input type="date" id="adate" name="adate" value="" class="form-control form-control-sm">
</div>
</div>
</div>
</div>
...
<div class="card-header">
<h5 class="card-title">
Box Description - Shipment Weight : <b></b>
</h5>
</div>
...
$(document).ready(function() {
  ...
  $('.multi-field-wrapper').each(function() {
    ...
    var fieldIndex = 0; // Initialize a field index
    $(".add-field", $(this)).click(function(e) {
        var newElement = $('.multi-field:last-child', $wrapper).clone(true).appendTo($wrapper);

        // Append the field index to the name attributes
        newElement.find('input[name="product_name[]"]').attr('name', 'product_name[' + fieldIndex + ']');
        newElement.find('input[name="product_quantity[]"]').attr('name', 'product_quantity[' + fieldIndex + ']');
        newElement.find('input[name="price[]"]').attr('name', 'price[' + fieldIndex + ']');
        newElement.find('input[name="hsn_code[]"]').attr('name', 'hsn_code[' + fieldIndex + ']');
        newElement.find('input[name="p_weight[]"]').attr('name', 'p_weight[' + fieldIndex + ']');

        // Increment the field index for the next set of fields
        fieldIndex++;

        // Clear the values of the new fields
        newElement.find('input[name="product_name[' + fieldIndex + ']"]').val('');
        newElement.find('input[name="product_quantity[' + fieldIndex + ']"]').val('');
        newElement.find('input[name="price[' + fieldIndex + ']"]').val('');
        newElement.find('input[name="hsn_code[' + fieldIndex + ']"]').val('');
        newElement.find('input[name="p_weight[' + fieldIndex + ']"]').val('');

        newElement.find('input[name="product_name[' + fieldIndex + ']"]').autocomplete({
            paramName: 'term',
                minChars: 3,
                maxHeight: 200,
