...
// fetch testimonials
$testi = mysqli_query($conn, "SELECT * FROM testimonials");
...
//fetch services
$services = mysqli_query($conn, "SELECT * FROM services ORDER BY id DESC LIMIT 3");
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="sec-title">
                            ...
                            <h2>Providing<br> Reliable Services <br> Since 2001</h2>
                    ...
                    <div class="col-lg-6">
                        <div class="image wow fadeInRight" data-wow-duration="1500ms"><img src="assets/images/resource/4.png" alt=""></div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="testimonial-block"> 
                    <div class="inner-box">
                        ...
                        <div class="author-thumb">
                            <img src="admin/images/testimonial/<?php //echo $row['img']; 
                                                                ?>" alt="">
                        ...
                        <h4><?php //echo $row['title']; 
                            ?></h4>
                        <div class="designation"><?php //echo $row['designation']; 
                                                    ?></div>
                        <div class="rating">
